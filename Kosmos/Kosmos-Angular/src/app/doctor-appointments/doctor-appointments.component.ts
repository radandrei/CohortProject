...
export class DoctorAppointmentsComponent {
  ...
  constructor(http: HttpClient,private userService:UserService, private appointmentService: AppointmentService, public dialog: MatDialog, private router:Router,private activatedRoute: ActivatedRoute) {
